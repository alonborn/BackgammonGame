...
class CheckersDetection:
	...
	HoughCircles_param1 = 200	#265 #300
	HoughCircles_param2 = 18    #17	#21
	...
	def ExtractCirclesFromImage(self, image):
		...
		#img = cv2.GaussianBlur(gray_img, (9, 9), 2)
		#cv2.imshow("medianBlur",img)
		img = gray_img
		#cv2.imshow("blur",img)

		circles = cv2.HoughCircles(img, cv2.HOUGH_GRADIENT, dp=1, minDist=10,param1=self.HoughCircles_param1, param2=self.HoughCircles_param2, minRadius=20, maxRadius=27)

		#circles	= cv2.HoughCircles(img,cv2.HOUGH_GRADIENT,0.8,45,param1=self.HoughCircles_param1,param2=self.HoughCircles_param2,minRadius=23,maxRadius=30)
	...
	def detect_black_white(self,gsimage,image,pos):
		...
		if bgr_values[0] >100 and bgr_values[1] > 100 and bgr_values[2] >100:
			return 'w'
